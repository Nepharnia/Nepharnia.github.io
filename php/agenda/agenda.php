...
<?php
if(isset($_GET['admin']))
	echo '<a href="agenda.php">Vous modifiez l agenda, pour le visualiser cliquez ici</a>';
else
	echo'<a href="?admin">Vous visualisez l agenda, pour le modifier cliquez ici</a>';
?>
</div>
